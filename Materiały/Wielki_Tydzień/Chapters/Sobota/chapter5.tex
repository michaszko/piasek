...
\begin{itemize}
	...
	\item \aa~ na \textit{Gloria} dzwonią dzwonkami; w tym czasie w sygnaturkę
	      uderza \tt~ i \cc1
	\item Msza biegnie normalnie; \cc1 idzie w tym czasie do chrzcielnicy i
	      sprząta co nieco.
	\item przed komunią (po przyjęciu komunii przez \ii) \cc2 zaczyna
	      \textit{Confiteor}!!!
...
\begin{itemize}
	...
	\item procesja rusza jak tylko rozpocznie się śpiew pieśni po polsku i
	      wygląda następująco:
	\item (tutaj obrazek)
	\item po przybyciu do Ołtarza, \aa~ i \ding{63} stają przy kredensie, \mm1
	      ustawia figurę zmartwychwstałego po stronie ewangelii i schodzi na
	      swoje miejsce, \tt~ staje po swojej stronie, \cc2 staje u stopni
	      Ołtarza po prawej stronie \ii, a \cc1 jak już odstawi parasolkę to
