...
\begin{itemize}
	...
	\item \cc1 odpala świeczkę od ognia i podaje \ii. Ten odpala paschał i potem
	      go błogosławi.
	\item \ii~ przebiera się w białą stułę i dalmatykę. Pomaga mu w tym \cc2
	      oraz \aa2.
	\item dopiero teraz nastepuje zasypanie.
	\item procesja z paschałem do kościoła: \tt, \ding{63}, \ii~ z paschałem,
	      \cc, \aa i \mm1, który zabiera tackę i kropidło.
