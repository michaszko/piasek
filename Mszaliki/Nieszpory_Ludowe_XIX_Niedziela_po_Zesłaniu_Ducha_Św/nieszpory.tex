...
\begin{center}
    ...
    \huge XIX NIEDZIELA PO ZESŁANIU DUCHA ŚWIĘTEGO
    ...
    {\large \textbf{19 października 2025}}
...
{\footnotesize
    ...
    Zapis gabc neumów: Piotr Matuszak; Andrew Hinkley, Br. Bernard Delgado-Braun OSB, Jacques Perriere, R\'{e}mi Roch \textit{gregobase.selapa.net}.
...
\fancyhead[CO]{XIX NIEDZIELA PO ZESŁANIU DUCHA ŚWIĘTEGO}
...
\vv Benedíctus Deus, et Pater Dómini nostri Iesu Christi, Pater
...
\gregorioscore{Melody/hy--lucis_creator_optime--solesmes_1961.1.gabc}
...
\gresetinitiallines{0}
\gregorioscore{Melody/dirigatur-domine-oratio-mea.gabc}
\gresetinitiallines{1}

\rr Sicut incensum in conspectu tu\textbf{o}.

\proroctwomedskip{Magnificat}

\gregorioscore{Melody/an--intravit_autem_rex--solesmes_1961.1.gabc}
...
\vv Oremus. Omnípotens et miséricors Deus, univérsa nobis adversántia propitiátus
exclúde: ut mente et córpore páriter expedíti, quæ tua sunt, líberis méntibus exsequámur.
Per Dóminum nostrum Iesum Christum, Fílium tuum: qui tecum vivit et
regnat in unitáte Spíritus Sancti, Deus, per ómnia sǽcula sæculórum. \rr Amen.
...
\gregorioscore{Melody/or--benedicamus_domino_in_dominicis_per_annum--solesmes_1934.gabc}
\gresetinitiallines{1}
